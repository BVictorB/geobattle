...
- [GeoBattle](#geobattle)
  ...
  * [:paperclip: &nbsp; API](#paperclip--api)
    + [:arrow_right: &nbsp; Forward geocoding](#arrow_right--forward-geocoding)
    + [:arrow_left: &nbsp; Reverse geocoding](#arrow_left--reverse-geocoding)
  ...
  * [:wrench: &nbsp; Dependencies](#wrench--dependencies)
    ...
    + [mongoose](#mongoose)
  * [:high_brightness: &nbsp; Final product](#high_brightness--final-product)
